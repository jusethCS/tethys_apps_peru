...
@controller(name='get_stations',url='historical-validation-tool-peru/get-stations')
...
@controller(name='get_data',url='historical-validation-tool-peru/get-data')
def get_data(request):
    ...
    return render(request, 'historical_validation_tool_peru/panel.html', context)





@controller(name='get_metrics_custom',url='historical-validation-tool-peru/get-metrics-custom')
...
@controller(name='get_raw_forecast_date',url='historical-validation-tool-peru/get-raw-forecast-date')
...
# Retrieve xlsx data
@controller(name='get_simulated_data_xlsx',url='historical-validation-tool-peru/get-simulated-data-xlsx')
...
# Retrieve xlsx data
@controller(name='get_corrected_data_xlsx',url='historical-validation-tool-peru/get-corrected-data-xlsx')
...
# Retrieve xlsx data
@controller(name='get_forecast_xlsx',url='historical-validation-tool-peru/get-forecast-xlsx')
...
@controller(name='get_corrected_forecast_xlsx',url='historical-validation-tool-peru/get-corrected-forecast-xlsx')
